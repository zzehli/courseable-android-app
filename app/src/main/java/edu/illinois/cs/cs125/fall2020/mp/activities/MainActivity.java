...
import static edu.illinois.cs.cs125.fall2020.mp.models.Summary.filter;
...
public final class MainActivity extends AppCompatActivity
  ...
  public boolean onQueryTextChange(final String query) {
    List<Summary> response = filter(courses, query);
    listAdapter.edit().replaceAll(response).commit();
    return true;
  }
