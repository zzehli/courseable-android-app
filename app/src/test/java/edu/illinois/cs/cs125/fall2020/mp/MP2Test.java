    ...
    public void testServerPostRating() throws IOException {
      ...
      for (int i = 0; i < 128; i++) {
        ...
        Request postRatingRequest =
            new Request.Builder()
                .url(url)
                // this is the where POST is specified
...
//      // start the server
//      Client client = Client.start();
//      // wait for callback before the test finishes
...
//              input.complete(theString);
//            }
//          });
//      // wait for the callback
//      assertThat(input.get()).isEqualTo("test");
//
//      // test case 2
...
//            @Override
//            public void testPost(String theString) {
//              secondInput.complete(theString);
//            }
//          });
//      // wait for the callback
//      assertThat(secondInput.get()).isEqualTo("test");
//    }
